...
class CommoditiesControllerTest < ActionController::TestCase
  ...
  test "should create commodity" do
    assert_difference('Commodity.count') do
      post :create, commodity: { category: @commodity.category, description: @commodity.description, name: @commodity.name }
    end
  ...
  test "should update commodity" do
    patch :update, id: @commodity, commodity: { category: @commodity.category, description: @commodity.description, name: @commodity.name }
    assert_redirected_to commodity_path(assigns(:commodity))
  end
